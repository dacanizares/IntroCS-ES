...
Define en tus propias palabras, pero tratando de ser muy claro y ordenado, las entradas, las salidas, la memoria y el programa para que la Máquina RAM pueda simular las siguientes situaciones:

	\begin{enumerate}
		\item Una calculadora que permita sumar y/o restar dos números.
		
		\item Un videojuego para jugar entre dos personas al \emph{triqui} o también conocido como tres en raya.
	\end{enumerate}
\end{Exercise}
\begin{Answer}	
