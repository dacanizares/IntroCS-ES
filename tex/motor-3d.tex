...
Para ver todo esto en Python, podemos utilizar un código como el \ref{cod-motor-raycast}.

\lstinputlisting[language=Python,caption=Variables generales del programa con algunos valores posibles.,label=cod-motor-raycast]{./py/motor-3d/raycast.py}
